<template>
  <PrivateLayout>
    <PrivateContainer>
      <TownsListSearchBar v-model="filters.location" class="mt-12 mb-12" />
      ...
      <TownsListFilters class="mb-8">
        ...
        <TownsListFilter
          ...
          :options="fieldTypes.map(f => ({ label: f.label, value: f.id }))"
        />
        <TownsListFilter
          ...
          :options="[
            ...
            { value: 'justiceProcedure', label: 'Procédure en cours' },
